...
namespace CIOS.Controllers
{
    ...
    public class AccountController :Controller
    {
        ...
        */
        ...
        {
            Schedule currentSchedule = db.Schedules.Find(1);
            if(currentSchedule.midReminder <= DateTime.Now && (currentSchedule.midReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
            ...
            if(currentSchedule.paperReminder <= DateTime.Now && (currentSchedule.paperReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
                foreach(var v in db.Students)
                {
                    if(v.hasInternship)
            ...
            if(currentSchedule.quizReminder <= DateTime.Now && (currentSchedule.quizReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
                foreach(var v in db.Students)
                {
                    if(v.hasInternship)
            ...
            if(currentSchedule.evalReminder <= DateTime.Now && (currentSchedule.evalReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
                foreach(var v in db.Students)
                {
                    if(v.hasInternship)
            ...
            if(currentSchedule.exitInterviewReminder <= DateTime.Now && (currentSchedule.exitInterviewReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
                foreach(var v in db.Students)
                {
                    if(v.hasInternship)
            ...
            if(currentSchedule.employerUpdateReminder <= DateTime.Now && (currentSchedule.employerUpdateReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
            ...
            if(currentSchedule.employerEvaluationReminder <= DateTime.Now && (currentSchedule.employerEvaluationReminder - new TimeSpan(1, 0, 0, 0)) >= DateTime.Now)
            {
                foreach(var v in db.Employers)
                {
                    if(v.hasIntern)
